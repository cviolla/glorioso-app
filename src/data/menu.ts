...
export const menuData: MenuCategory[] = [
  ...
  },
  {
    ...
    name: 'PIZZAS',
    items: [
      { id: 'pizza-mussarela', name: 'MUSSARELA', variants: [{ name: '25CM', price: 25.00 }, { name: '30CM', price: 32.00 }, { name: '35CM', price: 41.00 }] },
      { id: 'pizza-calabresa', name: 'CALABRESA', variants: [{ name: '25CM', price: 25.00 }, { name: '30CM', price: 32.00 }, { name: '35CM', price: 41.00 }] },
      { id: 'pizza-presunto', name: 'PRESUNTO', variants: [{ name: '25CM', price: 25.00 }, { name: '30CM', price: 32.00 }, { name: '35CM', price: 41.00 }] },
      { id: 'pizza-frango-catupiry', name: 'FRANGO COM CATUPIRY', variants: [{ name: '25CM', price: 26.00 }, { name: '30CM', price: 34.00 }, { name: '35CM', price: 41.00 }] },
      { id: 'pizza-bacon', name: 'BACON', variants: [{ name: '25CM', price: 28.00 }, { name: '30CM', price: 38.00 }, { name: '35CM', price: 45.00 }] },
      { id: 'pizza-bacon-ovos', name: 'BACON COM OVOS', variants: [{ name: '25CM', price: 28.00 }, { name: '30CM', price: 38.00 }, { name: '35CM', price: 45.00 }] },
      { id: 'pizza-queijo-bacon', name: 'QUEIJO MINAS + BACON', variants: [{ name: '25CM', price: 28.00 }, { name: '30CM', price: 38.00 }, { name: '35CM', price: 45.00 }] },
      { id: 'pizza-carne-seca', name: 'CARNE SECA', variants: [{ name: '25CM', price: 30.00 }, { name: '30CM', price: 40.00 }, { name: '35CM', price: 50.00 }] },
      { id: 'pizza-camarao', name: 'CAMARÃO', variants: [{ name: '25CM', price: 30.00 }, { name: '30CM', price: 40.00 }, { name: '35CM', price: 50.00 }] },
      { id: 'pizza-portuguesa', name: 'PORTUGUESA', variants: [{ name: '25CM', price: 30.00 }, { name: '30CM', price: 40.00 }, { name: '35CM', price: 50.00 }] },
    ]
  },
  {
    id: 'massas',
