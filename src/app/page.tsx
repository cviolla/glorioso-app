      ...
      <main className="flex-1 flex flex-col items-center justify-center px-6 relative z-10 w-full">
        ...
        >
          ...
          <div className="flex flex-col items-center gap-4 sm:gap-5 w-full">
            <div className="flex flex-col items-center gap-2.5 sm:gap-3 text-xs sm:text-sm text-[#f8ece3]/80">
              <a 
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer" 
                className="flex items-start sm:items-center justify-center gap-1.5 text-center hover:text-[#ff914a] transition-colors max-w-[280px] sm:max-w-none"
              >
                <MapPin className="w-4 h-4 text-[#ff914a] shrink-0 mt-0.5 sm:mt-0" />
                <span className="font-medium underline underline-offset-2 leading-snug">Avenida B Nº 195 - R. da Feira, Nova Campinas</span>
              </a>
              <div className="flex items-center justify-center gap-1.5 text-center text-[#f8ece3]/60 mt-1 sm:mt-0">
                <Clock className="w-4 h-4 text-[#ff914a] shrink-0" />
